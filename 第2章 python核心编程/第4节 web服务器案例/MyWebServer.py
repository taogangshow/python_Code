...
'''
测试1(动态web):http://localhost:7788/ctime
               http://localhost:7788/sayhello
测试2(静态web):http://localhost:7788/static/index.html     
'''
...
def main():
    ...
    #print("argv:",sys.argv)
    #argv: ['C:/Users/Administrator/PycharmProjects/untitled2/MyWebServer.py', 'MyWebFramework:app']
